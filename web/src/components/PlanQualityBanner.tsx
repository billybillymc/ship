...
export function PlanQualityBanner({
  ...
  useEffect(() => {
    ...
    quietGet(`/api/documents/${documentId}`)
      ...
      .catch((err: unknown) => { console.error('[PlanQuality] Request failed:', err); });
        ...
        <div className="flex items-center gap-3">
          {loading ? (
            <div className="flex items-center gap-2">
              <svg aria-hidden="true" className="w-4 h-4 animate-spin text-accent-foreground" viewBox="0 0 24 24" fill="none">
