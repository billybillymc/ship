    ...
    <div className="space-y-4 p-4">
      ...
      <div className="rounded-lg border border-border bg-accent/10 p-3">
        <div className="flex items-center justify-between mb-2">
          ...
          <span className="text-2xl font-bold text-accent-foreground tabular-nums">{iceScore ?? '—'}</span>
        </div>
          ...
          <div className="space-y-3">
            <label className="flex items-center cursor-pointer">
              <input
                ...
                className="h-4 w-4 rounded border-gray-300 text-accent-foreground focus:ring-accent focus:ring-offset-background"
              />
