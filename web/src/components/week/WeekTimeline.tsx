      ...
      >
        <div className="flex items-center justify-between mb-1">
          <span className="font-medium text-foreground text-sm">
            ...
            {isCurrentWindow && <span className="text-accent-foreground ml-1">(Current)</span>}
          </span>
        ...
        <div className="mt-2 flex items-center justify-between text-xs">
          <span className={cn(
            ...
            status === 'active' ? 'bg-accent/10 text-accent-foreground' : sprintStatusColors[status]
          )}>
            ...
            >
              <div className="relative h-full">
                ...
                <div className="absolute -top-5 left-1/2 -translate-x-1/2 whitespace-nowrap">
                  <span className="text-xs font-medium text-accent-foreground bg-background px-1 rounded">
                    Today
                  </span>
                </div>
              </div>
