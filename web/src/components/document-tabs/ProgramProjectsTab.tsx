    ...
    return (
      <div className="h-full overflow-auto p-4">
        ...
        <div className="flex flex-col items-center justify-center h-48 text-muted">
          <svg aria-hidden="true" className="w-12 h-12 mb-3 opacity-50" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2">
                ...
                <span className="inline-flex px-2 py-0.5 text-xs font-medium rounded bg-accent/10 text-accent-foreground">
            ...
            {/* Arrow */}
            <svg aria-hidden="true" className="w-4 h-4 text-muted flex-shrink-0" viewBox="0 0 20 20" fill="currentColor">
