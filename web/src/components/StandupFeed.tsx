  ...
  const createEditor = useEditor({
    extensions: [
      ...
      Link.configure({
        openOnClick: false,
        HTMLAttributes: {
          class: 'text-accent-foreground hover:underline cursor-pointer',
        },
      }),
    ],
    content: '',
      ...
      <div className="flex-1 overflow-auto px-4 py-3">
        {standups.length === 0 ? (
          <div className="flex flex-col items-center justify-center h-48 text-muted">
            <svg aria-hidden="true" className="h-10 w-10 mb-3 opacity-50" fill="none" stroke="currentColor" viewBox="0 0 24 24">
